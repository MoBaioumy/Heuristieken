...
if __name__ == "__main__":
    """
    This script runs the repeat algoritms of the hillclimber and simulated annealingself.
    These functions are used to find as low as possible scores. See for the parameters
    for the possible variations.
    """
    wijk = 2
    ...
    if algoritme == 1:
        ...
        save = 'no' # yes/no, save file to results
        ...
        cooling = 'sig' # lin, sig, exp, geman, cooling scheme
